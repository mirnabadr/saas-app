    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          Click the button below, and view the sample error on the Sentry <a target="_blank" href="https://personal-projects-0s.sentry.io/issues/?project=4510391680172032">Issues Page</a>.
